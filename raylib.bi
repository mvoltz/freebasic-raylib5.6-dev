...
declare function IsImageValid(byval image_ as Image) as byte
...
declare function IsTexturevalid(byval texture as Texture2D) as boolean
...
'' Color/pixel related
declare function ColorIsEqual(byval col1 as RLColor, byval col2 as RLColor) as boolean
...
declare function ColorLerp(byval color1 as RLColor, byval color2 as RLColor, byval factor as single) as RLColor
...
declare function IsFontValid(byval font as Font) as boolean
...
declare function TextToFloat(byval text as single ptr) as single
...
declare function IsModelValid(byval model as Model) as boolean
...
declare sub DrawModelPoints(byval model as Model, byval position as Vector3, byval scale as single, byval tint as RLColor)
declare sub DrawModelPointsEx(byval model as Model, byval position as Vector3, byval rotationAxis as Vector3, byval rotationAngle as single, byval scale as Vector3, byval tine as RLColor)
...
declare function IsMaterialValid(byval material as Material) as boolean
...
declare function IsWaveValid(byval wave as Wave) as boolean
...
declare function IsSoundValid(byval sound as Sound) as boolean
...
declare function IsMusicValid(byval music as Music) as boolean
